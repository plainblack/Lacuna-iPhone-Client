//
//  ProposeExpelMemberViewController.m
//  UniversalClient
//
...
@implementation ProposeExpelMemberViewController
            ...
            switch (indexPath.row) {
                case INDUCT_ROW_EMPIRE:
                    ...
                    if (self.selectedEmpire) {
                        ...
                        targetCell.textLabel.text = @"Pick Member To Expel";
                    }
                    cell = targetCell;
                    break;
                case INDUCT_ROW_MESSAGE:
...
#pragma mark -
#pragma mark SelectAllianceMemberViewControllerDelegate Methods
...
+ (ProposeExpelMemberViewController *)create {
	return [[[ProposeExpelMemberViewController alloc] init] autorelease];
}
