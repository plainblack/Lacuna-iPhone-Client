...
@interface LEBuildingExchangeWithStash : LERequest {
}
...
- (LERequest *)initWithCallback:(SEL)callback target:(NSObject *)target buildingId:(NSString *)buildingId buildingUrl:(NSString *)buildingUrl donation:(NSMutableDictionary *)donation request:(NSMutableDictionary *)request;
