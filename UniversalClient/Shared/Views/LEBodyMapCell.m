...
- (void)drawRect:(CGRect)rect {
	...
	if (self.mapBuilding) {
		...
		if (self.showOverlay) {
			...
			//Draw level
			[[self.mapBuilding.level stringValue] drawInRect:CGRectMake(30.0, 40.0, 40.0, 20.0) withFont:LEVEL_FONT lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentCenter];
