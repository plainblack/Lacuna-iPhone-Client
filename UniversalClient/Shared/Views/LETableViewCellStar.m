...
+ (LETableViewCellStar *)getCellForTableView:(UITableView *)tableView {
    ...
    if (cell == nil) {
		cell = [[LETableViewCellStar alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
		...
		cell.locationLabel.textAlignment = UITextAlignmentLeft;
