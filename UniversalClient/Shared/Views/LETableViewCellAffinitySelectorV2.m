...
- (void) alertView:(UIAlertView *) alertView clickedButtonAtIndex:(int)index {
	if (index != [alertView cancelButtonIndex]) {
		NSInteger diff = _intv([self.numericValue decimalNumberBySubtracting:[NSDecimalNumber one]]);
