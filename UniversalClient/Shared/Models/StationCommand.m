...
- (void)generateSections {
	...
	self.sections = _array([self generateProductionSection], actions, [self generateHealthSection], [self generateUpgradeSection], [self generateGeneralInfoSection]);
}
